  ...
  <SelectPrimitive.Trigger
    ...
    className={cn(
      `
        ...
        whitespace-nowrap shadow-xs ring-offset-background placeholder:text-muted-foreground focus:ring-1
        focus:ring-ring focus:outline-hidden disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1
      `,
      className,
    )}
    {...props}
    ...
    <SelectPrimitive.Content
      ...
      className={cn(
        `
          ...
          shadow-md data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2
