    ...
    <Dialog {...props}>
      <DialogContent className="overflow-hidden p-0">
        <Command className={`
          ...
          [&_[cmdk-group]:not([hidden])_~[cmdk-group]]:pt-0 [&_[cmdk-input-wrapper]_svg]:size-5 [&_[cmdk-input]]:h-12
...
>(({ className, ...props }, ref) => (
  <div className="sticky top-0 z-10 flex items-center border-b bg-white px-3" cmdk-input-wrapper="">
