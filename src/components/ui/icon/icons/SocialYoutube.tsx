...
export const IconSocialYoutube = ({ className, color = 'currentColor', size = 'fontSize', ...props }: IconProps) => (
  <svg
    width={sizes[size]}
    height={sizes[size]}
    viewBox="0 0 24 24"
    ...
    {...props}
  >
    <g clipPath="url(#youtube-clip0_17662_66357)">
      <path
        ...
        fill="#FF0302"
      />
      <path d="M9.56885 15.5686V8.43135L15.8416 12L9.56885 15.5686Z" fill="#FEFEFE" />
    </g>
    <defs>
      <clipPath id="youtube-clip0_17662_66357">
