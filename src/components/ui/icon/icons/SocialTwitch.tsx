...
export const IconSocialTwitch = ({ className, color = 'currentColor', size = 'fontSize', ...props }: IconProps) => (
  <svg
    width={sizes[size]}
    height={sizes[size]}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <path
      ...
      fill="#9146FF"
    />
    <path d="M18.0009 4.71428H16.2866V9.85714H18.0009V4.71428Z" fill="#9146FF" />
    <path d="M13.2866 4.71429H11.5723V9.85715H13.2866V4.71429Z" fill="#9146FF" />
  </svg>
);
