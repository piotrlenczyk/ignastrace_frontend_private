...
const cards: CardType[] = [
  { id: '1', icon: 'shield', title: 'reasons.reason_1.title', description: 'reasons.reason_1.description' },
  { id: '2', icon: 'user', title: 'reasons.reason_2.title', description: 'reasons.reason_2.description' },
  { id: '3', icon: 'ai', title: 'reasons.reason_3.title', description: 'reasons.reason_3.description' },
  { id: '4', icon: 'pin-location', title: 'reasons.reason_4.title', description: 'reasons.reason_4.description' },
  { id: '5', icon: 'globe', title: 'reasons.reason_5.title', description: 'reasons.reason_5.description' },
];
    ...
    <div className="w-full bg-alternate px-0 lg:rounded-3xl">
      <div className="container-wide px-4 py-10 lg:py-20">
        <div className="container-medium text-center">
          ...
          <p className="h4 text-weak">{t('subtitle')}</p>
        </div>
        <div className="grid w-full gap-4 py-6 md:grid md:grid-cols-[repeat(12,1fr)] md:gap-8 md:pt-16">
