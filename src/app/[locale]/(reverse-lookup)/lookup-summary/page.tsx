    ...
    <FunnelLayout isReverseLookup showLogoLink={false}>
      <main className="s-main overflow-hidden pb-10 md:pb-20 lg:px-6">
        <section className="container-wide">
          ...
          <div className="mx-4 mb-7 mt-4 grid grid-cols-1 gap-8 md:mb-5 md:mt-16 md:grid-cols-2 md:pt-2 lg:mx-0">
            <GetReport product={product} currency={currency} country={country} />
            <WhatYouGet />
          </div>
          <AsSeenOn className="mx-4 pb-6 pt-4 md:mx-0 md:py-10" />
          <CustomerOpinionsSection />
          <RecentReveals country={country} />
          <hr className="container-wide separator m-0 mx-4 md:mx-0 lg:mx-auto lg:mt-2 lg:block" />
