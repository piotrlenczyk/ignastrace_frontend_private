...
const ThankYouPage = async () => {
  ...
  const gtmEventValue = process.env.ENABLE_UPSELLS === 'true'
          ...
          <div className="container-small flex flex-col items-center gap-6 text-center">
            <div className="flex justify-center">
              <svg width="161" height="161" viewBox="0 0 161 161" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M89 11.5H38.5C34.0817 11.5 30.5 15.0817 30.5 19.5V123.5C30.5 127.918 34.0817 131.5 38.5 131.5H122.5C126.918 131.5 130.5 127.918 130.5 123.5V19.5C130.5 15.0817 126.918 11.5 122.5 11.5H104" stroke="#36394D" strokeOpacity="0.45" strokeWidth="2" strokeLinecap="round" />
                <path d="M94.5 11.5H98.5" stroke="#36394D" strokeOpacity="0.45" strokeWidth="2" strokeLinecap="round" />
                <path d="M60.5 43.5H100.763" stroke="#36394D" strokeOpacity="0.45" strokeWidth="2" strokeLinecap="round" />
                <path d="M66.0261 49.0261H95.2366" stroke="#36394D" strokeOpacity="0.45" strokeWidth="2" strokeLinecap="round" />
                <rect x="58" y="67.5" width="46" height="32.0357" rx="6" fill="white" />
                <rect x="59" y="68.5" width="44" height="30.0357" rx="5" stroke="#36394D" strokeOpacity="0.45" strokeWidth="2" />
                <line x1="58" y1="76.3572" x2="102.357" y2="76.3572" stroke="#36394D" strokeOpacity="0.45" strokeWidth="2" />
                <path d="M64.5 90.5L71.5 90.5" stroke="#36394D" strokeOpacity="0.45" strokeWidth="2" strokeLinecap="round" />
                <circle cx="102.5" cy="96" r="13.5" fill="white" />
                <circle cx="102.5" cy="96" r="12.5" stroke="#36394D" strokeOpacity="0.45" strokeWidth="2" />
                <path d="M107.167 92.5657C107.49 92.896 107.49 93.4314 107.167 93.7615L101.634 99.4342C101.311 99.7643 100.789 99.7643 100.467 99.4342L97.8326 96.7337C97.5104 96.4036 97.5104 95.8681 97.8326 95.538C98.1547 95.2077 98.677 95.2077 98.9991 95.538L101.05 97.6405L106.001 92.5657C106.323 92.2356 106.845 92.2356 107.167 92.5657Z" fill="#F23D00" />
              </svg>
